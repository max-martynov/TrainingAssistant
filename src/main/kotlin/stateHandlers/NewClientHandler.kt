    ...
    private suspend fun sendMainKeyboardBeforePayment(peerId: Int) {
        vkApiClient.sendMessageSafely(
            ...
            "Отлично! Давайте разберемся с основными кнопками:\n" +
                    " 🔹 Инструкция: прочитайте, чтобы ознакомится со всеми моими возможностями\n" +
                    ...
                    "Эти кнопки всегда можно свернуть и развернуть, нажав на значок на краю поля для ввода сообщения.",
